...
export type DerivedBoolean = DerivedBooleanExplicit | DerivedBooleanCharacteristic | boolean
...
export type DerivedString = DerivedStringExplicit | DerivedStringCharacteristic | string
...
export type DerivedValue = DerivedValueExplicit | DerivedValueBracket | DerivedValueCharacteristic | number
...
export type ComparatorLogic = {
  type: 'logic'
  operator: 'OR' | 'AND' | 'NOR',
  selectors: (ComparatorValue | ComparatorString | ComparatorBoolean | ComparatorLogic | ComparatorAutomatic)[],
}

export type Comparator = ComparatorValue | ComparatorString | ComparatorBoolean | ComparatorLogic | ComparatorAutomatic
...
export type CSEventAction = (env:Environment, state:CharacterState, path:string, data:unknown) => {state:CharacterState, events:CSEvent[]}
